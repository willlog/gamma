...
class Authitem extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, type', 'required', 'message'=>'Hay campos requeridos'),
			array('type', 'numerical', 'integerOnly'=>true,'message'=>'Tipo, solo datos numericos'),
			array('name,idedit', 'length', 'max'=>64),
