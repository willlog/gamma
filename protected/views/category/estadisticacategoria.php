...
<?php $this->setPageTitle("ESTADÍSTICAS CATEGORÍA"); ?>
...
<div class="row">
	...
	<br>
	<?php echo CHtml::link('Recomendados', array('/category/recomendadoscategoria/'.$model->id), array('target'=>'_blank', 'class'=>'btn btn-info btnVistaArticle'));  ?>
	<?php echo CHtml::link('Compartidos', array('/category/compartidoscategoria/'.$model->id), array('target'=>'_blank', 'class'=>'btn btn-info btnVistaArticle'));  ?>
	<?php echo CHtml::link('Visitados', array('/category/visitadoscategoria/'.$model->id), array('target'=>'_blank', 'class'=>'btn btn-info btnVistaArticle'));  ?>
	<?php echo CHtml::link('Gustados', array('/category/gustadoscategoria/'.$model->id), array('target'=>'_blank', 'class'=>'btn btn-info btnVistaArticle'));  ?>
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Educativos Total vs Recursos Educativos Categoría
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Educativos Total vs Recursos Educativos Categoría por Fechas
        <div style="float: right;"> 
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Educativos Total vs Recursos Educativos Categoría por Días
         <div style="float: right;"> 
	        <label>Tipo de Gráfica: </label>
...
<script type="text/javascript">
		function getPDF () {
			...
			doc.addImage(img2, 'PNG', 15 , 150, 180, 100);
			doc.addPage()
			doc.addImage(img3, 'PNG', 15 , 20, 180, 150);
			doc.addPage()
			doc.addImage(img4, 'PNG', 15 , 20, 180, 150);
			doc.save("estadistica_categoria.pdf");
		...
		jQuery(document).ready(function($){
			...
			$.ajax({
	        		type: "post",
	        		url: "/gamma/category/JSONoaactivosdesactivosporcategoria/"+$("#catid").val(),	        		
			        dataType: "json",
			        	...
			        	var b = new Array();
	                               var fila=0;
				                     for (var i = 0; i < response.length; i++) {
					                         ...
					                         b[fila]["label"]=response[i]['estado'];
					                         b[fila]["value"] = response[i]['cantidad'];				                         
			...
			$.ajax({
        		type: "post",
        		url: "/gamma/category/JSONoaporcategoria/"+$("#catid").val(),	        		
		        dataType: "json",
		        success: function(response, status) { 
		        	var html2='<div class="chart" id="categoriaanio" style="width:100%; height: 300px;"></div><div class="chart" id="tblTotal" ></div>';
					$("#panel1").html('');		
					$("#panel1").html(html2); 
		        	var html="<table id='tblTotalCategorias' border='1' class='table table-bordered table-striped results'><thead><th>Año</th><th>Recursos Categoría</th><th>Recursos Totales</th><th>Porcentaje(%)</th></thead><tbody>";      	
		        	var b = new Array();
                               var fila=0;
			                     for (var i = 0; i < response.length; i++) {
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 ...
			                    										 "sFileName":"totalvsrecursoscategoria.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$("#btnBuscar").on("click",function () {
				...
				$("#panel2").html(html2);					
					$.ajax({
		        		type: "post",
		        		url: "/gamma/category/JSONoaporcategoriamesrango/"+$("#catid").val(),	        		
				        dataType: "json",
				        data: {'fecha1':$("#fecha1").val(), 'fecha2':$("#fecha2").val()},
				        success: function(response, status) {   
				        	
				        	var html=null; 
			        		html="<table id='tblMesesCategorias' border='1' class='table table-bordered table-striped results'><thead><th>Mes</th><th>Recursos Categoría</th><th>Recursos Totales</th><th>Porcentaje(%)</th></thead><tbody>";     	
				        	var b = new Array();
		                               var fila=0;
					                     for (var i = 0; i < response.length; i++) {
						            ...
						            "aButtons": [
						                ...
						                },
						                {
						                    ...
						                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
				                    										 "sPdfMessage": encabezado, 
				                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
				                    										 "sFileName":"totalvsrecursoscategoriaporfechas.pdf"
								                    						}]
						                }
						            ]
						        }
			...
			$("#ddlLimit").on("change",function () {
				...
				{
					url1="/gamma/category/JSONoaporcategoria/"+$("#catid").val();
				}
				else
				{
					url1="/gamma/category/JSONoaporcategoriaanio/"+$("#catid").val();
				}	
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalvsrecursoscategoriaporanios.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$(document).on('click','.mes', function () {	
				...
				$("#panel3").html(html2);					
					$.ajax({
		        		type: "post",
		        		url: "/gamma/category/JSONoaporcategoriapordias/"+$("#catid").val(),	        		
				        dataType: "json",
				        data: {'mes':$(this).text()},
				        success: function(response, status) {   
				        	
				        	var html=null; 
			        		html="<table id='tblDiasCategorias' border='1' class='table table-bordered table-striped results'><thead><th>Día</th><th>Recursos Categoría</th><th>Recuros Totales</th><th>Porcentaje(%)</th></thead><tbody>";     	
				        	var b = new Array();
		                               var fila=0;
					                     for (var i = 0; i < response.length; i++) {
					                         html=html+"<tr><td><div class='dia' style='color:blue;'>"+response[i]['dia']+"</a></td><td>"+response[i]['cantidad']+"</td><td>"+response[i]['total']+"</td><td>"+response[i]['porcentaje']+"</td></tr>";
					                         b[fila] = new Array();
							...
							encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
							encabezado= encabezado+"<?php echo "							        					       "; ?>";
							encabezado= encabezado+"<?php echo "Total Recursos vs Recursos Categoría por Días"; ?>";
							encabezado= encabezado+"<?php echo "							    	"; ?>";
							encabezado= encabezado+"<?php echo "							        "; ?>";		
							encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";
							encabezado=encabezado+" Categoría: "+"<?php echo $model->name; ?>";		
			                
			                var table = $('#tblDiasCategorias').DataTable( {
								"paging":   true,
						        "ordering": true,
						        "info":     true,
						        'searching':true,
						            ...
						            "aButtons": [
						                ...
						                },
						                {
						                    ...
						                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
				                    										 "sPdfMessage": encabezado, 
				                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
				                    										 "sFileName":"totalvsrecursoscategoriapordias.pdf"
								                    						}]
						                }
						            ]
						        }
