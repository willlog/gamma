...
<div class="col-md-12 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Usuarios que mas comparten mis OA         
    </div>
    
    <div class="panel-body">  
    	<div class="chart" id="usuarios" style="height: 250px;"></div>  
    	<div class="chart" id="tblUsuarios" ></div>  
	</div>
...
<script type="text/javascript">
		...
		jQuery(document).ready(function($){
			"use strict";	
				...
				$.ajax({
	        		type: "post",
	        		url: "/gamma/user/JSONmascompartidosautor/"+$("#artid").val(),	        		
			        dataType: "json",
			        success: function(response, status) {
			        	var html2='<div class="chart" id="estadistica" style="width:100%; height: 300px;"></div><div class="chart" id="tblEstadistica" ></div>';
						$("#panel1").html('');		
						$("#panel1").html(html2);   
			        	var html="<table id='tblTotalCompartidos' border='1' class='table table-bordered table-striped results'><thead><th>Recurso Educativo</th><th>Compartidos</th></thead><tbody>";     	
			        	var b = new Array();
	                               var fila=0;
					...
					encabezado= encabezado+"<?php echo "							        					        "; ?>";
					encabezado= encabezado+"<?php echo "Recursos Más Compartidos por Usuario"; ?>";
					encabezado= encabezado+"<?php echo "							        	                                                                    		        "; ?>";
					encabezado= encabezado+"<?php echo "							        			 "; ?>";		
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
					                    								...
					                    								"sFileName":"mascompartidosautor.pdf"
					                    								} ]
					                }
					            ]
					        }
				...
				$.ajax({
	        		type: "post",
	        		url: "/gamma/share/JSONusuariosmascompartenmisoa/"+$("#artid").val(),	        		
			        dataType: "json",
			        success: function(response, status) {   
			        	var html="<table id='tblMesesCompartidos' border='1' class='table table-bordered table-striped results'><thead><th>Recurso Educativo</th><th>Compartidos</th></thead><tbody>";     	
			        	var b = new Array();
	                               var fila=0;
				                     for (var i = 0; i < response.length; i++) {
				                         html=html+"<tr><td><a href='"+response[i]['url']+"' target='_blank'>"+response[i]['nombre']+"</a></td><td>"+response[i]['compartidos']+"</td></tr>";
				                         b[fila] = new Array();
				                         b[fila]["y"]=response[i]['nombre'];
				                         b[fila]["a"] = response[i]['compartidos'];                                           		                         
				...
				$("#btnBuscar").on("click",function () {
					...
					$.ajax({
	        		type: "post",
	        		url: "/gamma/user/JSONmascompartidosautorrango/"+$("#artid").val(),	        		
			        dataType: "json",
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
					                    								...
					                    								"sPdfMessage": encabezado,
					                    								"sTitle": "                               											                             	   UNIVERSIDAD TÉCNICA DE AMBATO",
					                    								"sFileName":"mascompartidosautorfechas.pdf"
					                    								} ]
					                }
					            ]
					        }
