...
<table id="tblUsuariosact" class="table table-bordered table-striped results">
<thead>
	<tr>
        <th>#</th>
        <th></th>
           ...
           if ($(this).attr("value")=="eliminar") {
                ...
                $.ajax({
                    ...
                    success: function(response, status) {
                        ...
                        $('#valAct').html(obj.act);
                        $('#valCan').html(obj.can);
                        $("#btnUserActivadas").trigger( "click" );
                    },
                    error: function (response, status) {
                            alert("Error");
                    },
	        ...
	        tableTools: {
	            "aButtons": [
	                ...
	                "xls",
	                {
						...
						"sFileName":"usuarios_activados.pdf"
	                },
	                "print"
	            ]
	        }
