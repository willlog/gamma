...
<?php $this->setPageTitle("ESTADÍSTICA AUTOR"); ?>
...
<div class="row">
	...
	<tbody>
		<?php foreach ($dataProvider as $key => $value) { ?>
			<tr>		
				<td width="185px">&nbsp&nbsp<label><?php echo $value['accion']; ?></label></td>		
...
<table >
	...
	<tbody>
		<?php foreach ($dataProvider1 as $key => $value) { ?>
			<tr height="5px">		
				<td width="185px">&nbsp&nbsp<label><?php echo $value['estado']; ?></label></td>		
				<td><?php echo $value['cantidad']; ?></td>
			</tr>
		<?php } ?>		
	</tbody>
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Educativos Total vs Recursos Educativos Autor
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Educativos Total vs Recursos Educativos Autor por Meses
        <div style="float: right;"> 
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Educativos Total vs Recursos Educativos Autor por Días 
        <div style="float: right;"> 
	        <label>Tipo de Gráfica: </label>
...
<script type="text/javascript">
		...
		jQuery(document).ready(function($){		
				...
				var html2='<div class="chart" id="todosvsmismes" style="width:100%; height: 300px;"></div><div class="chart" id="tblMes" ></div>';
					...
					$.ajax({
				        ...
				        success: function(response, status) {				        	 
				        	var html="<table id='tblMesesAutor' border='1' class='table table-bordered table-striped results'><thead><th>Mes</th><th>Recursos Autor</th><th>Recursos Totales</th><th>Porcentaje (%)</th></thead><tbody>";       	
				        	var b = new Array();
		                               var fila=0;
							...
							encabezado= encabezado+"<?php echo "Recursos Educativos Autor por Meses"; ?>";
							encabezado= encabezado+"<?php echo "							    		        "; ?>";
							encabezado= encabezado+"<?php echo "							        			 "; ?>";		
			                ...
			                var table = $('#tblMesesAutor').DataTable( {
							"paging":   true,
					        "ordering": true,
					        "info":     true,
					        'searching':true,
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
												                    	...
												                    	"sFileName":"recursoautorpormeses.pdf"
														                } ]
					                }
					            ]
					        }
			...
			$.ajax({
				...
				$.ajax({
	        		type: "post",
	        		url: "/gamma/user/JSONaototalvsautoroa/"+$("#artid").val(),	        		
			        dataType: "json",
			        success: function(response, status) {
			        	var html2='<div class="chart" id="estadistica" style="width:100%; height: 300px;"></div><div class="chart" id="tblEstadistica" ></div>';
			        	$("#panel1").html('');		
						$("#panel1").html(html2);   
			        	var html="<table id='tblAniosAutor' border='1' class='table table-bordered table-striped results'><thead><th>Año</th><th>Recursos Autor</th><th>Recursos Totales</th><th>Porcentaje(%)</th></thead><tbody>";     	
			        	var b = new Array();
	                               var fila=0;
				                     for (var i = 0; i < response.length; i++) {
					...
					encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
					encabezado= encabezado+"<?php echo "							        					        "; ?>";
					encabezado= encabezado+"<?php echo "Total Recursos vs Recursos Autor"; ?>";
					encabezado= encabezado+"<?php echo "							    					        "; ?>";
					encabezado= encabezado+"<?php echo "							        			 "; ?>";		
					encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";
					encabezado=encabezado+" Usuario: "+"<?php echo $model->name; ?>";
					
	                var table = $('#tblAniosAutor').DataTable( {
							"paging":   true,
					        "ordering": true,
					        "info":     true,
					        'searching':true,
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalvsrecursosautor.pdf"
							                    						}]
					                }
					            ]
					        }
				...
				$("#ddlLimit").on("change",function () {
					...
					{
						url1="/gamma/user/JSONaototalvsautoroa/"+$("#artid").val();
					}
					else
					{
					...
					$.ajax({
						...
						encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
						encabezado= encabezado+"<?php echo "							        					        "; ?>";
						encabezado= encabezado+"<?php echo "Total Recursos vs Recursos Autor por Años"; ?>";
						encabezado= encabezado+"<?php echo "							        	"; ?>";
						encabezado= encabezado+"<?php echo "							        	"; ?>";		
						encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";
						encabezado=encabezado+" Usuario: "+"<?php echo $model->name; ?>";
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalvsreursosautorporanios.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$(document).on('click','.mes', function () {				
				var html2='<div class="chart" id="todosvsmisdia" style="width:100%; height: 300px;"></div><div class="chart" id="tblDia" ></div>';
					...
					$.ajax({
				        ...
				        data: {'mes':$(this).text()},
				        success: function(response, status) {				        	 
				        	var html="<table id='tblDiasAutor' border='1' class='table table-bordered table-striped results'><thead><th>Día</th><th>Recursos Autor</th><th>Recursos Totales</th><th>Porcentaje (%)</th></thead><tbody>";       	
				        	var b = new Array();
		                               var fila=0;
					                     for (var i = 0; i < response.length; i++) {
			                ...
			                //var bar = new Morris.Area({
			                   ...
			                   var encabezado="<?php echo "		  					                											              "; ?>";	
								encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
								encabezado= encabezado+"<?php echo "							        					        "; ?>";
								encabezado= encabezado+"<?php echo "Total Recursos vs Recursos Autor por Días"; ?>";
								encabezado= encabezado+"<?php echo "							        	"; ?>";
								encabezado= encabezado+"<?php echo "							        	"; ?>";		
								encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";
								encabezado=encabezado+" Usuario: "+"<?php echo $model->name; ?>";
			                
			                 var table = $('#tblDiasAutor').DataTable( {
							"paging":   true,
					        "ordering": true,
					        "info":     true,
					        'searching':true,
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalvsreursosautorpordias.pdf"
							                    						}]
					                }
					            ]
					        }
