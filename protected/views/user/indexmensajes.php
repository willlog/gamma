...
<?php $this->setPageTitle("MENSAJES RECIBIDOS"); ?>
<section class="content">  
<div class="col-sm-12">
	<?php echo CHtml::link('<i class="fa fa-envelope"> Ver Enviados</i>', array('/user/Indexmensajesenviados'), array('class'=>'btn btnVistaArticle'));  ?>
	<br/>
	<br/>	
	<small class="badge bg-blue"><h4><code id="namepertenese">MENSAJES RECIBIDOS</code></h4></small>
	<br/>
	<br/> 
	...
	<div class="table-responsive" id="tableArticles">
	            <table id="tblArticle" class="table table-bordered table-striped results">
					...
					<tr>
	                    ...
	                    <td><?php echo CHtml::link($value['subject'], '', array('target'=>'_blank'));  ?></td>
	                    <td><?php echo $value['datesend']; ?></td>
	                                      
	                    <td>
	                    	<div class="btn-group">       
	                            <?php echo CHtml::link('<i class="fa fa-eye"></i>', array('/user/vermensaje/'.$value['id']), array('target'=>'_blank', 'class'=>'btn btn-info btnVistaArticle'));  ?>                          
	                        </div>
	                    </td>
	                </tr>
	        ...
	        tableTools: {
	            "aButtons": [
	                ...
	                "xls",
	                {
	                    ...
	                    "sFileName":"mensajes_recibidos.pdf"
	                },
	                "print"
	            ]
	        }
