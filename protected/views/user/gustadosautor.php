...
<script type="text/javascript">
			...
			"use strict";				
				$.ajax({
	        		type: "post",
	        		url: "/gamma/user/JSONmasgustadosautor/"+$("#artid").val(),	        		
			        dataType: "json",
			        success: function(response, status) {
			        	var html2='<div class="chart" id="estadistica" style="width:100%; height: 300px;"></div><div class="chart" id="tblEstadistica" ></div>';
						$("#panel1").html('');		
						$("#panel1").html(html2);    
			        	var html="<table id='tblTotalGustados' border='1' class='table table-bordered table-striped results'><thead><th>Recurso Educativo</th><th>Gustados</th></thead><tbody>";     	
			        	var b = new Array();
	                               var fila=0;
					...
					encabezado= encabezado+"<?php echo "							        					        "; ?>";
					encabezado= encabezado+"<?php echo "Recursos Más Gustados por Usuario"; ?>";
					encabezado= encabezado+"<?php echo "							        	                                                                    		        "; ?>";
					encabezado= encabezado+"<?php echo "							        			 "; ?>";		
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
					                    								...
					                    								"sFileName":"masgustadosautor.pdf"
					                    								} ]
					                }
					            ]
					        }
				...
				$("#btnBuscar").on("click",function () {
					...
					$.ajax({
	        		type: "post",
	        		url: "/gamma/user/JSONmasgustadosautorrango/"+$("#artid").val(),	        		
			        dataType: "json",
			        ...
			        success: function(response, status) {
						...
						$("#panel2").html('');		
						$("#panel2").html(html2);    
			        	var html="<table id='tblMesesGustados' border='1' class='table table-bordered table-striped results'><thead><th>Recurso Educativo</th><th>Gustados</th></thead><tbody>";     	
			        	var b = new Array();
	                               var fila=0;
				                     for (var i = 0; i < response.length; i++) {
				                         html=html+"<tr><td><a href='"+response[i]['url']+"' target='_blank'>"+response[i]['title']+"</a></td><td>"+response[i]['cantidad']+"</td></tr>";
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
					                    								...
					                    								"sPdfMessage": encabezado,
					                    								"sTitle": "                               											                             	   UNIVERSIDAD TÉCNICA DE AMBATO",
					                    								"sFileName":"masgustadosautorfechas.pdf"
					                    								} ]
					                }
					            ]
					        }
