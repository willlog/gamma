...
<?php $this->setPageTitle("MENSAJES ENVIADOS"); ?>
<section class="content">  
<div class="col-sm-12">
	<?php echo CHtml::link('<i class="fa fa-envelope"> Ver Recibidos</i>', array('/user/Indexmensajes'), array('class'=>'btn btnVistaArticle'));  ?>
	<br/>
	<br/>
	<small class="badge bg-blue"><h4><code id="namepertenese">MENSAJES ENVIADOS</code></h4></small>
	<br/>
	<br/> 
	...
	<div class="table-responsive" id="tableArticles">
	            <table id="tblArticle" class="table table-bordered table-striped results">
					...
					<tr>
	                    ...
	                    <td>
	                    	<div class="btn-group">       
	                            <?php echo CHtml::link('<i class="fa fa-eye"></i>', array('/user/vermensajeenviado/'.$value['id']), array('target'=>'_blank', 'class'=>'btn btn-info btnVistaArticle'));  ?>                          
	                        </div>
	                    </td>
	                </tr>
	        ...
	        tableTools: {
	            "aButtons": [
	                ...
	                "xls",
	                {
	                    ...
	                    "sFileName":"mensajes_enviados.pdf"
	                },
	                "print"
	            ]
	        }
