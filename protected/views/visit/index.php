...
<?php $this->setPageTitle("ESTADÍSTICAS MIS VISITAS"); ?>
...
<div class="row">
    ...
    <div class="panel-heading">
        <i class="fa fa-eye"></i> Recursos Visitados Total vs Mis Recursos 
...
<div class="col-md-10 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Visitados Total vs Mis Recursos por Meses
        <div style="float: right;"> 
...
<div class="col-md-10 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Visitados Total vs Mis Recursos por Días
        <div style="float: right;"> 
	        <label>Tipo de Gráfica: </label>
...
<script type="text/javascript">
		...
		jQuery(document).ready(function($){	
			...
			$("#btnBuscar").on("click",function () {
				...
				$.ajax({
	        		type: "post",
	        		url: "/gamma/visit/JSONvisitanmisoapormesrango/",	        		
			        dataType: "json",
			        data: {'fecha1':$("#fecha1").val(), 'fecha2':$("#fecha2").val()},
			        success: function(response, status) { 
			        	var html="<table id='tblMesesVisitas' border='1' class='table table-bordered table-striped results'><thead><th>Mes</th><th>Visitas Autor</th><th>Visitas Totales</th><th>Porcentaje (%)</th></thead><tbody>";       	
			        	var b = new Array();
	                               var fila=0;
						...
						encabezado= encabezado+"<?php echo "Total Visitas vs Mis Recursos por Meses"; ?>";
						encabezado= encabezado+"<?php echo "									        "; ?>";
						encabezado= encabezado+"<?php echo "						        			 "; ?>";		
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", { "sExtends": "pdf",	                    
			                    										 ...
			                    										 "sFileName":"totalvisitasvsmisreursosfechas.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$.ajax({
        		type: "post",
        		url: "/gamma/visit/JSONvisittotal",	        		
		        dataType: "json",
		        success: function(response, status) {  
		        	var html2='<div class="chart" id="visitasporanio" style="width:100%; height: 300px;"></div><div class="chart" id="tblTotal" ></div>';
					$("#panel1").html('');		
					$("#panel1").html(html2);
		        	var html="<table id='tblAniosVisitas' border='1' class='table table-bordered table-striped results'><thead><th>Año</th><th>Visitas Autor</th><th>Visitas Totales</th><th>Porcentaje (%)</th></thead><tbody>";      	
		        	var b = new Array();
                               var fila=0;
			                     for (var i = 0; i < response.length; i++) {
					...
					encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
					encabezado= encabezado+"<?php echo "							        					        "; ?>";
					encabezado= encabezado+"<?php echo "Total Visitas vs Mis recursos"; ?>";
					encabezado= encabezado+"<?php echo "							        					        "; ?>";
					encabezado= encabezado+"<?php echo "							        			 "; ?>";		
					encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";									
	                
	                var table = $('#tblAniosVisitas').DataTable( {
							"paging":   true,
					        "ordering": true,
					        "info":     true,
					        'searching':true,
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalvisitasvsmisreursos.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$("#ddlLimit").on("change",function () {
				...
				{
					url1="/gamma/visit/JSONvisittotal";
				}
				else
				{
					url1="/gamma/visit/JSONvisit";
				}
			...
			$(document).on('click','.mes', function () {
				...
				$.ajax({
	        		type: "post",
	        		url: "/gamma/visit/JSONvisitanmisoapordias/",	        		
			        dataType: "json",
			        data: {'mes':$(this).text()},
			        success: function(response, status) { 
			        	var html="<table id='tblDiasVisitas' border='1' class='table table-bordered table-striped results'><thead><th>Día</th><th>Visitas Autor</th><th>Visitas Totales</th><th>Porcentaje (%)</th></thead><tbody>";       	
			        	var b = new Array();
	                               var fila=0;
				                     for (var i = 0; i < response.length; i++) {
						...
						encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
						encabezado= encabezado+"<?php echo "						        					        "; ?>";
						encabezado= encabezado+"<?php echo "Total Visitas vs Mis Recursos por Días"; ?>";
						encabezado= encabezado+"<?php echo "									        "; ?>";
						encabezado= encabezado+"<?php echo "						        			 "; ?>";		
						encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";
						encabezado=encabezado+" Usuario: <?php echo $model->name?>";						
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalvisitasvsmisreursosdias.pdf"
							                    						}]
					                }
					            ]
					        }
