...
<?php $this->setPageTitle("ESTADÍSTICAS MIS COMPARTIDOS"); ?>
...
<div class="row">
    ...
    <div class="panel-heading">
        <i class="fa fa-fw fa-share-square-o"></i> Recursos Compartidos Total vs Mis Recursos
...
<div class="col-md-10 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Compartidos Total vs Mis Recursos por Meses
         <div style="float: right;"> 
...
<div class="col-md-10 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Compartidos Total vs Mis Recursos por Días
         <div style="float: right;"> 
	        <label>Tipo de Gráfica: </label>
	...
	function getPDF () {				
		...
		jQuery(document).ready(function($){	
			...
			$("#btnBuscar").on("click",function () {
				...
				$.ajax({
        		type: "post",
        		url: "/gamma/share/JSONcompartenmisoapormesrango/",	        		
		        dataType: "json",
		        data: {'fecha1':$("#fecha1").val(), 'fecha2':$("#fecha2").val()},
		        success: function(response, status) {
		        	var html=null; 
		        	html="<table id='tblMesesCompartidos' border='1' class='table table-bordered table-striped results'><thead><th>Mes</th><th>Compartidos Autor</th><th>Compartidos Totales</th><th>Porcentaje (%)</th></thead><tbody>";       	
		        	var b = new Array();
                               var fila=0;
					...
					encabezado= encabezado+"<?php echo "Total Compartidos vs Mis Recursos por Meses"; ?>";
					encabezado= encabezado+"<?php echo "									    "; ?>";
					encabezado= encabezado+"<?php echo "						        		"; ?>";		
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", { "sExtends": "pdf",	                    
			                    										 ...
			                    										 "sFileName":"totalcompartidosvsmisreursosfechas.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$(document).on('click','.mes', function () {	
				...
				$.ajax({
        		type: "post",
        		url: "/gamma/share/JSONcompartenmisoapordias/",	        		
		        dataType: "json",
		        data: {'mes':$(this).text()},
		        success: function(response, status) {
		        	var html=null; 
		        	html="<table id='tblDiasCompartidos' border='1' class='table table-bordered table-striped results'><thead><th>Día</th><th>Compartidos Autor</th><th>Compartidos Totales</th><th>Porcentaje (%)</th></thead><tbody>";       	
		        	var b = new Array();
                               var fila=0;
			                     for (var i = 0; i < response.length; i++) {
					...
					encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
					encabezado= encabezado+"<?php echo "						        					        "; ?>";
					encabezado= encabezado+"<?php echo "Total Compartidos vs Mis Recursos por Días"; ?>";
					encabezado= encabezado+"<?php echo "									      "; ?>";
					encabezado= encabezado+"<?php echo "						        		 "; ?>";		
					encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";
					encabezado=encabezado+" Usuario: <?php echo $model->name?>";						
	                ...
	                var table = $('#tblDiasCompartidos').DataTable( {
							"paging":   true,
					        "ordering": true,
					        "info":     true,
					        'searching':true,
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalcompartidosvsmisreursosdias.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$.ajax({
        		type: "post",
        		url: "/gamma/share/JSONsharetodosarticulos",	        		
		        dataType: "json",
		        success: function(response, status) { 
		        	var html2='<div class="chart" id="compartidosporanio" style="width:100%; height: 300px;"></div><div class="chart" id="tblTotal" ></div>';
					$("#panel1").html('');		
					$("#panel1").html(html2); 
		        	var html="<table id='tblAniosCompartidos' border='1' class='table table-bordered table-striped results'><thead><th>Año</th><th>Compartidos Autor</th><th>Compartidos Totales</th><th>Porcentaje (%)</th></thead><tbody>";      	
		        	var b = new Array();
                               var fila=0;
			                     for (var i = 0; i < response.length; i++) {
	                ...
	                var table = $('#tblAniosCompartidos').DataTable( {
							"paging":   true,
					        "ordering": true,
					        "info":     true,
					        'searching':true,
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalcompartidosvsmisreursos.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$("#ddlLimit").on("change",function () {
				...
				{
					url1="/gamma/share/JSONsharetodosarticulos";
				}
				else
				{
					url1="/gamma/share/JSONsharemisarticulos";
				}	
