...
<?php $this->setPageTitle("ESTADÍSTICAS COMPARTIDOS"); ?>
...
<div class="row">
    ...
    <div class="panel-heading">
        <i class="fa fa-fw fa-share-square-o"></i> Recursos Compartidos Total 
...
<div class="col-md-10 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Compartidos Total por Meses
         <div style="float: right;"> 
...
<div class="col-md-10 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recursos Compartidos Total por Días
         <div style="float: right;"> 
	        <label>Tipo de Gráfica: </label>
...
<script type="text/javascript">
		...
		function getPDF () {				
			...
			doc.save("compartidosgeneral.pdf");
		...
		jQuery(document).ready(function($){		
			...
			$("#btnBuscar").on("click",function () {
				...
				$.ajax({
        		type: "post",
        		url: "/gamma/share/JSONtodoscompartidospormesrango/",	        		
		        dataType: "json",
		        data: {'fecha1':$("#fecha1").val(), 'fecha2':$("#fecha2").val()},
		        success: function(response, status) {
		        	var html=null; 
		        	html="<table id='tblMesesCompartidos' border='1' class='table table-bordered table-striped results'><thead><th>Mes</th><th>Compartidos Totales</th></thead><tbody>";       	
		        	var b = new Array();
                               var fila=0;
			                     for (var i = 0; i < response.length; i++) {
			                         html=html+"<tr><td><div class='mes' style='color:blue;'>"+response[i]['mes']+"</div></td><td>"+response[i]['compartido']+"</td></tr>";
			                         b[fila] = new Array();
					...
					encabezado= encabezado+"<?php echo "Total Compartidos por Meses                  "; ?>";
					encabezado= encabezado+"<?php echo "									    "; ?>";
					encabezado= encabezado+"<?php echo "						        		"; ?>";		
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", { "sExtends": "pdf",	                    
			                    										 ...
			                    										 "sFileName":"totalcompartidospormeses.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$(document).on('click','.mes', function () {	
					...
					$.ajax({
	        		type: "post",
	        		url: "/gamma/share/JSONtodoscompartidospordias/",	        		
			        dataType: "json",
			        data: {'mes':$(this).text()},
			        success: function(response, status) {
			        	var html=null; 
			        	html="<table id='tblDiasCompartidos' border='1' class='table table-bordered table-striped results'><thead><th>Día</th><th>Total Compartidos</th></thead><tbody>";       	
			        	var b = new Array();
	                               var fila=0;
				                     for (var i = 0; i < response.length; i++) {
				                         html=html+"<tr><td><div class='dia' style='color:blue;'>"+response[i]['dia']+"</div></td><td>"+response[i]['compartido']+"</td></tr>";
				                         b[fila] = new Array();
						...
						encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
						encabezado= encabezado+"<?php echo "						        					        "; ?>";
						encabezado= encabezado+"<?php echo "Total Compartidos por Días"; ?>                      ";
						encabezado= encabezado+"<?php echo "									      "; ?>";
						encabezado= encabezado+"<?php echo "						        		 "; ?>";		
						encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";							
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {"sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalcompartidospordias.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$.ajax({
        		type: "post",
        		url: "/gamma/share/JSONsharetodos",	        		
		        dataType: "json",
		        success: function(response, status) {
		        	var html2='<div class="chart" id="compartidosporanio" style="width:100%; height: 300px;"></div><div class="chart" id="tblTotal" ></div>';
					$("#panel1").html('');		
					$("#panel1").html(html2);     
		        	var html="<table id='tblTotalCompartidos' border='1' class='table table-bordered table-striped results'><thead><th>Año</th><th>Compartidos Totales</th></thead><tbody>";      	
		        	var b = new Array();
                               var fila=0;
			                     for (var i = 0; i < response.length; i++) {
					...
					encabezado= encabezado+"<?php echo "SOCIAL MEDIA ACADEMIC NETWORK"; ?>";
					encabezado= encabezado+"<?php echo "						        					        "; ?>";
					encabezado= encabezado+"<?php echo "Total Compartidos                              "; ?>";
					encabezado= encabezado+"<?php echo "									           "; ?>";
					encabezado= encabezado+"<?php echo "						        			   "; ?>";		
					encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>";					
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {  "sExtends": "pdf",	                    
			                    										 "sPdfMessage": encabezado, 
			                    										 "sTitle": "                                  UNIVERSIDAD TÉCNICA DE AMBATO",
			                    										 "sFileName":"totalcompartidos.pdf"
							                    						}]
					                }
					            ]
					        }
			...
			$("#ddlLimit").on("change",function () {
				...
				{
					url1="/gamma/share/JSONsharetodos";
				}
				else
				{
					url1="/gamma/share/JSONsharetodosporanio";
				}
