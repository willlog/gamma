...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">    	
        <i class="fa fa-bar-chart-o fa-fw"></i> Recomendados de Todos los Tiempos  
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> Recomendados por Fecha  
        <div style="float: right;"> 
	        <label>Top: </label>
			...
			"use strict";				
				$.ajax({					
			        ...
			        success: function(response, status) {   
						...
						$("#panel1").html('');		
						$("#panel1").html(html2);
			        	var html="<table id='tblTotalRecomendados' border='1' class='table table-bordered table-striped results'><thead><th>Título</th><th>Creador</th><th>Compartidos</th><th>Visitado</th><th>Gustado</th><th>Recomendado</th></thead><tbody>";     	
			        	var b = new Array();
	                               var fila=0;
					...
					encabezado= encabezado+"<?php echo "							        					        "; ?>";
					encabezado= encabezado+"<?php echo "Recursos Recomendados de Todos los Tiempos"; ?>";
					encabezado= encabezado+"<?php echo "					                                                          		        "; ?>";
					encabezado= encabezado+"<?php echo "							        			 "; ?>";		
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
													                    ...
													                    "sFileName":"recomendadostodoslostiempos.pdf"
													                }]
					                }
					            ]
					        }
				...
				$("#ddlLimit").on("change",function () {					
					...
					$.ajax({
				        ...
				        dataType: "json",
				        success: function(response, status) {   
				        	var html="<table id='tblTotalRecomendados' border='1' class='table table-bordered table-striped results'><thead><th>Título</th><th>Creador</th><th>Compartidos</th><th>Visitado</th><th>Gustado</th><th>Relevancia</th></thead><tbody>";     	
				        	var b = new Array();
		                               var fila=0;
					                     for (var i = 0; i < response.length; i++) {
					                         html=html+"<tr><td><a href='"+response[i]['url']+"' target='_blank'>"+response[i]['title']+"</a></td><td>"+response[i]['name']+"</a></td><td>"+response[i]['share']+"</td><td>"+response[i]['visit']+"</td><td>"+response[i]['likes']+"</td><td>"+response[i]['recomendado']+"</td></tr>";
				...
				$("#btnBuscar").on("click",function () 
				{
					$.ajax({
		        		type: "post",
		        		url: "/gamma/article/JSONMasrecomendadosrango/",	        		
				        dataType: "json",
						...
						$("#panel2").html(html2);  
				        var html=null; 
			        	html="<table id='tblMesesRecomendados' border='1' class='table table-bordered table-striped results'><thead><th>Título</th><th>Creador</th><th>Compartidos</th><th>Visitas</th><th>Gustados</th></th><th>Relevancia</th></thead><tbody>";      	
				        	var b = new Array();
		                               var fila=0;
					                     for (var i = 0; i < response.length; i++) {
					                         html=html+"<tr><td><a href='"+response[i]['url']+"' target='_blank'>"+response[i]['title']+"</a></td><td>"+response[i]['name']+"</a></td><td>"+response[i]['share']+"</td><td>"+response[i]['visit']+"</td><td>"+response[i]['likes']+"</td><td>"+response[i]['recomendado']+"</td></tr>";
							...
							encabezado= encabezado+"<?php echo "							        					        "; ?>";
							encabezado= encabezado+"<?php echo "							        			        "; ?>";
							encabezado= encabezado+"<?php echo "Recursos Recomendados por Fechas                "; ?>";
							encabezado= encabezado+"<?php echo "		  	                                                                    		        "; ?>";
							encabezado= encabezado+"<?php echo "					        			 "; ?>";		
							encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>         ";												        			                         "; ?>";
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
													                    ...
													                    "sPdfOrientation": "landscape",            
													                    "sTitle": "                               											                             	   UNIVERSIDAD TÉCNICA DE AMBATO",
													                    "sFileName":"recomendadosporfechas.pdf"
														                }]
					                }
					            ]
					        }
