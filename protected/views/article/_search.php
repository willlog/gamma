...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'reading',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'state'); ?>
		<?php echo $form->textField($model,'state',array('size'=>60,'maxlength'=>15)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'kind'); ?>
		<?php echo $form->textField($model,'kind',array('size'=>60,'maxlength'=>15)); ?>
	</div>
