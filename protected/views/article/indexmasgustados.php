...
<?php $this->setPageTitle("RECURSOS MÁS GUSTADOS"); ?>
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">    	
        <i class="fa fa-bar-chart-o fa-fw"></i> Mas Gustados de Todos los Tiempos  
...
<div class="col-md-11 alpha omega ">	
    ...
    <div class="panel-heading">    	
        <i class="fa fa-bar-chart-o fa-fw"></i> Mas Gustados por Fechas 
...
<script type="text/javascript">
		...
		jQuery(document).ready(function($){		
			"use strict";				
				$.ajax({					
	        		type: "post",
	        		url: "/gamma/article/JSONMasgustadostotal/",	        		
			        dataType: "json",
			        success: function(response, status) {   
			        	var html2='<div class="chart" id="estadistica" style="width:100%; height: 300px;"></div><div class="chart" id="tblEstadistica" ></div>';
						$("#panel1").html('');		
						$("#panel1").html(html2);
			        	var html="<table id='tblTotalGustados' border='1' class='table table-bordered table-striped results'><thead><th>Título</th><th>Creador</th><th>Gustados</th></thead><tbody>";     	
			        	var b = new Array();
	                               var fila=0;
				                     for (var i = 0; i < response.length; i++) {
				                         html=html+"<tr><td><a href='"+response[i]['url']+"' target='_blank'>"+response[i]['title']+"</a></td><td>"+response[i]['name']+"</a></td><td>"+response[i]['likes']+"</td></tr>";
				                         b[fila] = new Array();
					...
					encabezado= encabezado+"<?php echo "							        					        "; ?>";
					encabezado= encabezado+"<?php echo "Recursos Más Gustados de Todos los Tiempos"; ?>";
					encabezado= encabezado+"<?php echo "					                                                          		        "; ?>";
					encabezado= encabezado+"<?php echo "							        			 "; ?>";		
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
													                    ...
													                    "sFileName":"masgustadostodoslostiempos.pdf"
														                }]
					                }
					            ]
					        }
				...
				$("#btnBuscar").on("click",function () 
				{
					$.ajax({
		        		type: "post",
		        		url: "/gamma/article/JSONMasgustadosrango/",	        		
				        dataType: "json",
						...
						$("#panel2").html(html2);  
				        var html=null; 
			        	html="<table id='tblMesesGustados' border='1' class='table table-bordered table-striped results'><thead><th>Título</th><th>Creador</th><th>Gustados</th></thead><tbody>";      	
				        	var b = new Array();
		                               var fila=0;
					                     for (var i = 0; i < response.length; i++) {
					                         html=html+"<tr><td><a href='"+response[i]['url']+"' target='_blank'>"+response[i]['title']+"</a></td><td>"+response[i]['name']+"</a></td><td>"+response[i]['likes']+"</td></tr>";
							...
							encabezado= encabezado+"<?php echo "							        					        "; ?>";
							encabezado= encabezado+"<?php echo "							        			        "; ?>";
							encabezado= encabezado+"<?php echo "Recursos Más Gustados por Fechas               "; ?>";
							encabezado= encabezado+"<?php echo "		  	                                                                    		        "; ?>";
							encabezado= encabezado+"<?php echo "					        			 "; ?>";		
							encabezado= encabezado+"Fecha: <?php print(date('m/d/Y h:i:s a', time())); ?>         ";												        			                         "; ?>";
					            ...
					            "aButtons": [
					                ...
					                },
					                {
					                    ...
					                    "aButtons":    [ "csv","xls", {
													                    ...
													                    "sPdfOrientation": "landscape",            
													                    "sTitle": "                               											                             	   UNIVERSIDAD TÉCNICA DE AMBATO",
													                    "sFileName":"masgustadosporfechas.pdf"
														                }]
					                }
					            ]
					        }
